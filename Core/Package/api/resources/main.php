<div class="warframe_header">
    <span class="warframe_header-title">Панель управления API</span><br>
...
<div class="warframe_card">
    <div class="warframe_card-body">
        ...
        <button onclick="checkModal('/cPanelApi/get')" class="warframe_btn">Добавить</button>
