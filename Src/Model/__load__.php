...
abstract class Model
{
    ...
    */
    ...
    final public function list(bool $counter = false): array
    {
        try {
            $this->generateSql();
    ...
    */
    ...
    ---------------------------------------------
    */
    final public function as(string $context): Model
    {
        /*
    ...
    final public function Data(string $context = "*"): Model
    {
        /*
            Установка столбцов которые хотим вытащить, по умолчаню все!
        */
    ...
    final public function Limit(int $limit = null): Model
    {
        /*
    ...
    final public function Join(Model $model, string $on): Model
    {
        /*
    ...
    final public function JoinLEFT(Model $model, string $on): Model
    {
        /*
            Установка дополнений в скрипе!
            До WHERE!
    ...
    final public function JoinRIGHT(Model $model, string $on): Model
    {
        /*
            Установка дополнений в скрипе!
            До WHERE!
    ...
    final public function Wr($context): Model
    {
        /*
            Установка зависимостей!
        */
    ...
    final public function Order(string $context): Model
    {
        /*
    ...
    final public function Group(string $context): Model
    {
        /*
    ...
    */
    ...
    ---------------------------------------------
    */
    final public function showError(bool $status = false): Model
    {
