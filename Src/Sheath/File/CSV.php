 ...
 * Class CSV
 *
 * `CSV` is a utility class for handling operations related to CSV files. It includes static methods for reading, writing, and rewriting CSV files.
 *
...
abstract class CSV
{
    ...
    {
        $info = pathinfo($path);
        if ($info['extension'] != 'csv') $path .= '.csv';
