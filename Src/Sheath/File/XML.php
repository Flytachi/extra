 ...
 * Class XML
 *
 * `XML` is a utility class designed to handle operations related to XML files. This class includes methods for reading XML files, converting XML strings to arrays, and converting arrays to XML.
 *
...
abstract class XML
{
    ...
    public static function stringToArray(string $xmlString): array
    {
        ...
        if ($xmlObject === false) throw new FileException('Error parsing XML string');
